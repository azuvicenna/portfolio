...
const projects = ref([
  {
    ...
    summary: 'Comprehensive health reporting system for local government.',
    content: '# SIMGos\n\nFull detail here...',
...
const saveProject = () => {
  ...
  const toolsArray = form.value.tools
    .split(',')
    .map(t => t.trim())
    .filter(t => t !== '');
          ...
          <tr v-for="item in projects" :key="item.id" class="group hover:bg-gray-50/80 transition duration-200">
            ...
            <td class="px-6 py-5">
              <div class="space-y-1.5">
                ...
                <p class="text-xs text-gray-500 font-medium truncate max-w-[150px]">
                  {{ item.tools.join(', ') }}
                </p>
              </div>
            </td>
            ...
            <div
              ...
              <div class="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p class="text-slate-400 text-sm">Showcase your latest work to the world.</p>
                </div>
              ...
              <form @submit.prevent="saveProject" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div class="md:col-span-1 space-y-4">
                    <div class="bg-gray-50 rounded-2xl p-4 border border-gray-200 text-center">
                      <img :src="form.imageUrl || 'https://via.placeholder.com/300'" alt="Preview"
                  ...
                  <div class="md:col-span-2 space-y-5">
                    ...
                    <div class="space-y-2">
                      <label class="text-xs font-bold text-slate-500 uppercase tracking-wider">Project Title</label>
                      <input v-model="form.title" type="text" placeholder="e.g. E-Commerce API"
                    ...
                    <div class="grid grid-cols-2 gap-5">
                      ...
                      <div class="space-y-2">
                        ...
                        <div class="relative">
                          <span class="absolute left-4 top-3.5 text-gray-400 text-sm">/projects/</span>
                          <input v-model="form.slug" type="text" placeholder="e-commerce-api"
                    ...
                    <div class="space-y-2">
                      <label class="text-xs font-bold text-slate-500 uppercase tracking-wider">Tech Stack (Comma
                        Separated)</label>
                      <input v-model="form.tools" type="text" placeholder="React, Node.js, MongoDB"
                        class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none text-slate-800" />
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-5">
                      <div class="space-y-2">
                        ...
                        <input v-model="form.demoUrl" type="url" placeholder="https://demo.com"
                          class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none text-slate-800" />
                      </div>
                      <div class="space-y-2">
                ...
                <div class="space-y-2">
                  ...
                  <textarea v-model="form.summary" rows="2" placeholder="Short description for the card..."
                ...
                <div class="space-y-2">
                  ...
                  <textarea v-model="form.content" rows="6" placeholder="# Project Details..."
